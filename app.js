...
// trying to do it with arrow func
...
//ANS: in the old way (this) goes to joe object, in the new way when its called it goes to the window object.
// 2. What is "this" when joe.scopeArrow() is invoked?
//ANS:becaue its called while its an arrow function so it will relate to the window.
// 3. Explain why "this" is different when an arrow function is used.
//because of its syntax, the arrow functions does not allow constructors or prototypes, (this) will always refer to the window object  